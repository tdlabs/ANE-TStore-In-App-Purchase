package
{
	...
	public class TStoreIAP extends Sprite
	{
		...
		private var appId:String = "OA00314053";
		private var bp_ip:String = null;
		private var bp_port:String = null;
		
		private var pID:String = "0900689411";
		private var pID_invalid:String = "0900689FFF";
...
//				TStoreInAppPurchase.init();
		...
		{
			//暂时不要移除signal，popPurchaseDlg_onItemPurchaseComplete还未完成
